                    ...
                    <div class="panel-group" id="accordion">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#collapse1_1">1. Create account. </a></h3>
                            </div>
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <input class="form-control" type="text" name="username" value="{$CALC.DGC.difficulty}"
                                                       size="10" maxlength="20" required>
                                            </div>
                                            <div class="col-md-6">
                                                <label>Block Reward:</label>
                                                <i class="fa fa-puzzle-piece"></i>
                                                <input class="form-control" type="text" name="password" value="{$CALC.DGC.reward}.00000000"
                                                       size="10" maxlength="20" required>&nbsp;
                                            </div>
                                        </div>
                                        <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <label>Difficulty:</label>
                                                <i class="fa fa-code-fork"></i>
                                                <input class="form-control" type="text" name="username" value="{$CALC.DOGE.difficulty}"
                                                       size="10" maxlength="20" required>
                                            </div>
                                            <div class="col-md-6">
                                                <label>Block Reward:</label>
                                                <i class="fa fa-puzzle-piece"></i>
                                                <input class="form-control" type="text" name="password" value="{$CALC.DOGE.reward}.00000000"
                                                       size="10" maxlength="20" required>&nbsp;
                                            </div>
                                        </div>
                                        <div class="row">
