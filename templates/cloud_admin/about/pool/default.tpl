<div class="col-md-12">
    <div class="box border">
        <div class="box-title">{$GLOBAL.website.name}</div>
        <div class="box-body">
        {*<table width="100%">*}
        {*<tbody>*}
            ...
            <ul>
                ...
                <li><a href="https://github.com/ArtForz/pushpool/tree/tenebrix">Pushpool 0.5.1-tenebrix</a>, a modified
                    version of Pushpool supporting changed target difficulties (2^20 in this pool)
                </li>
                <li>2. Provides the API each worker (client miner) authenticates and connects to</li>
                <li><a href="https://github.com/TheSerapher/php-mpos">MPOS</a> (proper hashrate for 2^20 target
                    difficulty)
                </li>
                <li>3. The Webinterface merging SQL and API information into a cohesive interface for user and worker
                    management
                </li>
            </ul>
