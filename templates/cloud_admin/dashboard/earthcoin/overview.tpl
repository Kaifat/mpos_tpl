        ...
        <div class="box-body">
            <center>
                <div style="display: inline-block;">
                    <div id="poolhashrate_earthcoin" style="width:120px; height:90px;"></div>
                    <div id="sharerate_earthcoin" style="width:120px; height:90px;"></div>
                </div>
                <div style="display: inline-block;">
                    <div id="hashrate_earthcoin" style="width:220px; height:180px;"></div>
                </div>
                <div style="display: inline-block;">
                    <div id="nethashrate_earthcoin" style="width:120px; height:90px;"></div>
                    <div id="querytime_earthcoin" style="width:120px; height:90px;"></div>
                </div>
            </center>
