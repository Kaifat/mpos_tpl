        ...
        <div class="box-body">
            <div class="tabbable header-tabs">
                <ul class="nav nav-tabs">
                    <li><a href="#tab_4" data-toggle="tab"><i class="fa fa-desktop"></i> <span
                            class="hidden-inline-mobile">tab 4</span></a></li>
                    <li><a href="#tab_3" data-toggle="tab"><i class="fa fa-desktop"></i> <span
                            class="hidden-inline-mobile">tab 3</span></a></li>
                    <li><a href="#tab_2" data-toggle="tab"><i class="fa fa-desktop"></i> <span
                            class="hidden-inline-mobile">tab 2</span></a></li>
                    <li class="active"><a href="#tab_1" data-toggle="tab"><i class="fa fa-flask"></i> <span
                            class="hidden-inline-mobile">tab 1</span></a></li>
                </ul>
