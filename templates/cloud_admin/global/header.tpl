...
<li class="dropdown" id="header-message">
    ...
    <ul class="dropdown-menu inbox">
        ...
        <li>
            <a href="#">
                <img src="{$PATH}/img/avatars/avatar2.jpg" alt="" />
									<span class="body">
        ...
        <li>
            <a href="#">
                <img src="{$PATH}/img/avatars/avatar1.jpg" alt="" />
									<span class="body">
        ...
        <li>
            <a href="#">
                <img src="{$PATH}/img/avatars/avatar8.jpg" alt="" />
									<span class="body">
...
<li class="dropdown user" id="header-user">
    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
        <img alt="" src="{$PATH}/img/avatars/avatar3.jpg" />
...
<li class="current">
    <a href="javascript:void(0);">
				  <span class="image">
					  <img src="{$PATH}/img/avatars/avatar3.jpg" alt="" />
				  </span>
				  <span class="title">
					You
				  </span>
...
<li>
    <a href="javascript:void(0);">
				  <span class="image">
					  <img src="{$PATH}/img/avatars/avatar4.jpg" alt="" />
				  </span>
				  <span class="title">
					Ellie Doe
				  </span>
...
<li>
    <a href="javascript:void(0);">
				  <span class="image">
					  <img src="{$PATH}/img/avatars/avatar5.jpg" alt="" />
				  </span>
				  <span class="title">
					Lisa Doe
				  </span>
...
<li>
    <a href="javascript:void(0);">
				  <span class="image">
					  <img src="{$PATH}/img/avatars/avatar6.jpg" alt="" />
				  </span>
				  <span class="title">
					Kelly Doe
				  </span>
...
<li>
    <a href="javascript:void(0);">
				  <span class="image">
					  <img src="{$PATH}/img/avatars/avatar7.jpg" alt="" />
				  </span>
				  <span class="title">
					Jessy Doe
				  </span>
